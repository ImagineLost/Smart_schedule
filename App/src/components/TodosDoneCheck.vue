...
<template>
  <div class="container">
    ...
    <div v-if="totalDone === 0">
      <p class="fw-bold">Пока нет выполненных задач. Очень жаль, но не сдавайтесь, продолжайте работать над своими целями!</p>
    </div>
    <div v-if="totalDone <= 10 && totalDone > 0">
